...
public final class AuxiliaryFileFilter extends FileFilter {
    ...
    /**
     * It represents the description of this auxiliary file filter. More generally, the description
     * gives a concise context about what files will be filtered.
     */
    ...
    /**
     * It inform whether or not a file that is a directory must be filtered, that is, if this
     * variable is {@code true} then directories will be filtered; otherwise, it will not.
     */
    private final boolean filterDirectory;

    /**
     * Constructor of {@link AuxiliaryFileFilter} specifying the file filter description, extensions
     * and whether file filter must filter directories as well.
     *
     * @param description
     *     the description
     * @param extensions
     ...
     *
     * @return {@code true} if this file is to be accepted; otherwise, {@code false} is returned.
     */
    @Override
