...
public class MachineTable extends AbstractTableModel {
    ...
    private String returnNameForIndex (final int rowIndex) {
        return switch (rowIndex) {
            ...
            case MachineTable.PROCESSOR -> "%s (Mflop/s)".formatted(this.words.getString("Computing power"));
    ...
    private void setValueAtIndex (final Object value, final int rowIndex) {
        switch (rowIndex) {
            ...
            case MachineTable.OWNER -> this.machine.setOwner(this.users.getSelectedItem().toString());
