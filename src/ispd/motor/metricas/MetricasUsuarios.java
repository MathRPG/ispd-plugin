...
public class MetricasUsuarios {
    ...
    public void addMetricasUsuarios (MetricasUsuarios mtc) {
        for (int i = 0; i < mtc.usuarios.size(); i++) {
            ...
            if (index == null) {
                ...
                this.limites.put(
                        mtc.listaUsuarios.get(i),
                        mtc.limites.get(usuarios.get(this.listaUsuarios.indexOf(mtc.listaUsuarios.get(i))))
                );
    ...
    public String toString () {
        ...
        for (int i = 0; i < usuarios.size(); i++) {
            texto += "Usuario: " + usuarios.get(i) + " tarefas: sub " + tarefasSubmetidas.get(i).size() + " con " +
                     tarefasConcluidas.get(i).size() + "\n";
        }
        return texto;
    }
}
