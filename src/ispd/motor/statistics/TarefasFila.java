...
public class TarefasFila {
    ...
    public void imprimeTarefas () {
        System.out.printf("\nFila DO TIPO: %d\n", getTipoMetrica());
        for (NoTarefasFila temp : fila) {
            System.out.printf("Tarefa ID: %d --> Tamanho %g --> " + "TempoMedioFila --> %f TempoMedioServidor --> %f" +
                              " TempoMedioSistema --> %f\n", temp.getIdTarefa(), temp.getTamanhoTarefa(),
                              getTempoMedioFila(), getTempoMedioServidor(), getTempoMedioSistema()
            );
        }
    }
    ...
    public void setTempoSaidaSistema (int idTarefa, Double tempo) {
        ...
        for (NoTarefasFila no : fila) {
            if (no.getIdTarefa() == idTarefa) {
                ...
                } else {    //setTempoMedioSistema( idTarefa );
                    //no.setTempoSaidaSistema( tempo );
    ...
    public void imprimeTar () {
        for (NoTarefasFila no : fila) {
            System.out.printf(
                    "TAREFA ID %d    TEMP CHEGADA %f   TEMP CHEGADA SERV %f   TEMP SAIDA %f   \n", no.getIdTarefa(),
                    no.getTempoChegadaFila(), no.getTempoChegadaServidor(), no.getTempoSaidaSistema()
            );
        }
    }
