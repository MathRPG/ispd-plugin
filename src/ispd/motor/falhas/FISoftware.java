...
public class FISoftware {
     ...
     */
    public void FISoftware (ProgressoSimulacao janela, RedeDeFilasCloud redeDeFilas, List<Tarefa> tarefas) throws
    ...
    }//public SimulacaoSequencialCloud(ProgressoSimulacao janela, RedeDeFilasCloud redeDeFilas, List<Tarefa> tarefas)
    // throws IllegalArgumentException {
