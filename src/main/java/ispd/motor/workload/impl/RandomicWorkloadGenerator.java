...
/**
 * Base class for {@link WorkloadGenerator}s that involve random generation of task attributes, such
 * as computation and communication size.<br> It also standardizes the use of a
 * {@link Supplier<Integer>} for generating task ids.
 */
public abstract class RandomicWorkloadGenerator extends TaskBuilder implements WorkloadGenerator {
    ...
    /**
     * {@link Distribution} to be used to roll random values, using the fields {@link #computation}
     ...
     * @param idSupplier
     *     supplier of ids for the generated tasks. It must supply <b>at least {@code taskCount}
     *     unique</b> ids, lest the results be undefined.
     * @param random
     *     {@link Distribution} to be invoked to generate random values when needed.
     */
    ...
    /**
     * @return an id generated by the {@link #idSupplier}, to be used to make a new task.
     */
    @Override
    ...
    /**
     * @return random communication size (in MBits), generated in accordance to the
     * {@link TwoStageUniform} set for it.
     */
    @Override
    ...
    /**
     * @return random computation size (in MFlops), generated in accordance to the
     * {@link TwoStageUniform} set for it.
     */
    @Override
