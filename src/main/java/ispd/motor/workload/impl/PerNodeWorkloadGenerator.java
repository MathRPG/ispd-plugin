...
public class PerNodeWorkloadGenerator extends RandomicWorkloadGenerator {
     ...
     *
     * @param application
     *     workload's originating application
     * @param owner
     *     id (name) of the user who owns the workload
     * @param schedulerId
     *     id of the machine which the workload will be directed to
     * @param taskCount
     ...
     * @param idSupplier
     *     supplier of ids for the generated tasks. Must supply at least {@code taskCount} ids
     */
    ...
    /**
     * Construct an instance from a {@link List} of attributes.<br> The order of the attributes in
     * the list must be consistent between this method, and its
     * {@link PerNodeWorkloadGenerator#toVector() toVector} method.
     *
     * @param row
     *     {@link List} of attributes to construct a generator.
     * @param idSupplier
     *     supplier of ids for the generated tasks.
     *
    ...
    /**
     * Generate tasks as configured, all targeted to the first master found with id matching the one
     * in {@link #schedulerId}. If no appropriate master is found, this method returns an empty
     * {@link ArrayList}.
     *
     * @param qn
    ...
    /**
     * The string representation for this workload generator includes is task count, application,
     * owner, scheduler id, and distributions for generating computation and communication sizes.
     */
    @Override
    ...
    /**
     * The task creation time generation involves an exponential distribution, with
     * {@code beta = 5}, and possibly an added delay depending on the task owner's id.
     *
    ...
    /**
     * Build a {@link Vector} with data from this instance, in the following order:
     * <ol>
    ...
    /**
     * @return id of the scheduler (i.e., master) that will host the tasks generated by this
     */
    ...
    /**
     * @return no extra delay for most users, but an extra {@value #ON_NO_DELAY} seconds if the task
