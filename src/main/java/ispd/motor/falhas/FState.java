...
public class FState {
    ...
    public void FIState1 (final ProgressoSimulacao janela, final RedeDeFilasCloud redeDeFilas) {
        ...
        if (redeDeFilas.getVMs() == null) {
            ...
            machineDown = CS_MaquinaCloud.DESLIGADO;
            ...
            for (int i = 0; i < machineNumber; i++) {
                if (machineDown == 2) {
                    ...
                    newMachine  = CS_MaquinaCloud.DESLIGADO;
                } else {
