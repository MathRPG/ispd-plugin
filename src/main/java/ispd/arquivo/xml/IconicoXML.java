...
public class IconicoXML {
    ...
    /**
     * Add cluster icon with the given attributes to the current model being built.
    ...
    /**
     * Add IaaS cluster icon with the given attributes to the current model being built.
     ...
     * without costs. See
     * {@link #newCharacteristic(Double, Integer, Double, Double, Double, Double, Double)} for
     * further info.
     */
    private Node newCharacteristic (
        final Double power, final Integer coreCount, final Double memory, final Double disk
     ...
     * also two extra params, {@code extraAttrs} and {@code extraMasterAttrs}, which are arrays
    ...
    /**
     * Add a virtual machine icon with the given attributes to the current model being built.
     */
     ...
     *
     * @apiNote This method just be called at most <b>once</b>> per instance, and not mixed with
     * calls to {@link #setLoadTrace(String, int, String)} or
     ...
     *
     * @apiNote This method may be called more than once per instance, however it should be mixed
     * with calls to {@link #setLoadTrace(String, int, String)} or
     * {@link #setLoadRandom(int, int, double, double, double, double, double, double, double,
     * double)}.
     */
