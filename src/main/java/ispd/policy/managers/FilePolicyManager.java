...
public abstract class FilePolicyManager implements PolicyManager {
    ...
    /**
     * Writes the contents of {@code codigo} into the source file of the policy given by
     * {@code nome}.
     *
     * @param nome
     *     Name of the policy which source file will be written to
     * @param codigo
    ...
    /**
     * Attempts to compile the source file of the policy with given name, returning the contents of
     * stderr, if any, otherwise {@code null}.
     *
     * @param nome
     *     Name of the allocation policy to be compiled
     *
    ...
    /**
     * Reads the source file from the policy {@code policy} and returns a string with the file
     * contents.
     *
     * @param policy
     *     Name of the policy which source file will be read
     *
    ...
    /**
     * Attempts to remove .java and .class files with the name in {@code policy} and, if successful,
     * removes the policy from the inner list.
     *
     * @param policy
     *     Name of the policy which files will be removed
     *
    ...
    /**
     * Adds allocation policy coded in file {@code arquivo} to the configured directory, compiles
     * it, and adds it to the list of allocation policies.
     *
     * @param arquivo
     *     Java source file containing the allocation policy
     *
